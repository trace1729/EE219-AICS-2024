...
add         x5,     x5,     x0          ; vadd.vi     vx2,    vx0,    8,    1       ; nop                                       ; 
nop                                     ; vadd.vi     vx2,    vx0,    8,    1       ; nop                                       ; 
add         x5,     x5,     x0          ; nop                                       ; vse32.v     vx2,    x5,             1     ;   mem[0][0:7]=8
addi        x5,     x5,     32          ; nop                                       ; nop                                       ;

# Test for vadd.vx
addi        x7,     x0,     9           ; nop                                       ; nop                                       ;
nop                                     ; vadd.vx     vx3,    vx0,    x7,     1     ; nop                                       ; 
...
# Test for vmul.vi
nop                                     ; vadd.vi     vx2,    vx0,    1,      1     ; nop                                       ; 
nop                                     ; vmul.vi     vx2,    vx2,    13,     1     ; nop                                       ; 
...
nop                                     ; vmul.vx     vx2,    vx2,    x7,     1     ; nop                                       ; 
nop                                     ; nop                                       ; vse32.v     vx2,    x5,             1     ;   mem[5][0:7]=7
addi        x5,     x5,     32          ; nop                                       ; nop                                       ; 

# Test for vmul.vv
nop                                     ; vadd.vi     vx2,    vx0,    10,     1     ; nop                                       ; 
nop                                     ; vadd.vi     vx3,    vx0,    10,     1     ; nop                                       ; 
nop                                     ; vmul.vv     vx2,    vx2,    vx3,    1     ; nop                                       ; 
